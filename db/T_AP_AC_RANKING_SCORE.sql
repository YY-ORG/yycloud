...
BEGIN
  ...
  IF (NEW.AUDIT_SCORE <> OLD.AUDIT_SCORE OR OLD.AUDIT_SCORE IS NULL) THEN
          ...
          IF V_CUR_RANKING_SCORE IS NULL THEN
            ...
            ELSE
               ...
               UPDATE PER_EXAMINEE_RANKING PER SET PER.TOTAL_RANKING=PER.TOTAL_RANKING+1, PER.ORG_RANKING=PER.ORG_RANKING+1 WHERE PER.SCORE<NEW.AUDIT_SCORE AND PER.ASSESSPAPER_ID=NEW.ASSESS_PAPER_ID;
          ...
          ELSE
            -- Update the Users' ranking = ranking + 1 whose score < the current user's score.
            UPDATE PER_EXAMINEE_RANKING PER SET PER.TOTAL_RANKING=PER.TOTAL_RANKING-1, PER.ORG_RANKING=PER.ORG_RANKING-1 WHERE PER.SCORE<V_CUR_RANKING_SCORE AND PER.ASSESSPAPER_ID=NEW.ASSESS_PAPER_ID;
            ...
            -- Update the current User's ranking
            ...
            -- Update the Users' ranking = ranking + 1 whose score < the current user's score.
            UPDATE PER_EXAMINEE_RANKING PER SET PER.TOTAL_RANKING=PER.TOTAL_RANKING+1, PER.ORG_RANKING=PER.ORG_RANKING+1 WHERE PER.SCORE<NEW.AUDIT_SCORE AND PER.ID <> V_CUR_RANKING_ID AND PER.ASSESSPAPER_ID=NEW.ASSESS_PAPER_ID;
