...
@RestController
@Slf4j
public class MPPOrgnizationController {

    @Autowired
    private OrgnizationService orgnizationService;

    @RequestMapping(value = "/authsec/mpp/organizations/page/{page}/size/{size}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "MPP用户中心-组织管理，获取所有机构")
    @ApiImplicitParams({
    ...
    @RequestMapping(value = "/authsec/mpp/organization", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "MPP用户中心-组织管理，创建")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "header", name = "Authorization", dataType = "String", required = true, value = "Token", defaultValue = "bearer ")
    })
    ...
    @RequestMapping(value = "/authsec/mpp/organization/{organization_id}", method = RequestMethod.PUT)
    @ApiOperation(value = "MPP用户中心-组织管理，修改")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "header", name = "Authorization", dataType = "String", required = true, value = "Token", defaultValue = "bearer ")
    })
    ...
    @RequestMapping(value = "/authsec/mpp/organization/{organization_id}", method = RequestMethod.DELETE)
    @ApiOperation(value = "MPP用户中心-组织管理，删除")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "header", name = "Authorization", dataType = "String", required = true, value = "Token", defaultValue = "bearer ")
    })
    ...
    @RequestMapping(value = "/authsec/mpp/organization/{organization_id}/enable", method = RequestMethod.PUT)
    @ApiOperation(value = "MPP用户中心-组织管理，启用")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "header", name = "Authorization", dataType = "String", required = true, value = "Token", defaultValue = "bearer ")
    })
    ...
    @RequestMapping(value = "/authsec/mpp/organization/{organization_id}/disable", method = RequestMethod.PUT)
    @ApiOperation(value = "MPP用户中心-组织管理，禁用")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "header", name = "Authorization", dataType = "String", required = true, value = "Token", defaultValue = "bearer ")
    })
    ...
    @RequestMapping(value = "/authsec/mpp/organization/{organization_id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "MPP用户中心-组织管理，获取单个机构")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "header", name = "Authorization", dataType = "String", required = true, value = "Token", defaultValue = "bearer ")
    })
    ...
    @RequestMapping(value = "/authsec/mpp/organization/platforms/nonorganization", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "MPP用户中心-组织管理，获取无机构管理平台")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "header", name = "Authorization", dataType = "String", required = true, value = "Token", defaultValue = "bearer ")
    })
    ...
    @RequestMapping(value = "/authsec/mpp/organization/enterprise/{enterprise_id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "MPP用户中心-组织管理，根据企业获得组织")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "header", name = "Authorization", dataType = "String", required = true, value = "Token", defaultValue = "bearer ")
    })
    ...
    @RequestMapping(value = "/authsec/mpp/organization/resource/{organization_id}", method = RequestMethod.POST)
    @ApiOperation(value = "MPP用户中心-组织管理，首次创建资源配额")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "header", name = "Authorization", dataType = "String", required = true, value = "Token", defaultValue = "bearer ")
    })
    ...
    @RequestMapping(value = "/authsec/mpp/organization/resource/{organization_id}", method = RequestMethod.PUT)
    @ApiOperation(value = "MPP用户中心-组织管理，更新资源配额")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "header", name = "Authorization", dataType = "String", required = true, value = "Token", defaultValue = "bearer ")
    })
    ...
    @RequestMapping(value = "/authsec/mpp/organization/resource/{organization_id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "MPP用户中心-组织管理，获得组织的资源配额")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "header", name = "Authorization", dataType = "String", required = true, value = "Token", defaultValue = "bearer ")
    })
