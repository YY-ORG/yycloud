...
package com.yy.cloud.api.basis.config;
...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Basis API").description("LizCloud Platform Management core API")
				.contact(new Contact("XJ CHEN", "http://www.google.com", "xue-jin.chen@gemii.cc")).version("0.1").build();
	}
}
