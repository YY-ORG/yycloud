...
package com.yy.cloud.api.basis.service.impl;

import java.util.ArrayList;
import java.util.Collection;
import java.util.List;

import com.yy.cloud.api.basis.clients.SysBaseClient;
import com.yy.cloud.api.basis.service.SysBaseService;
import com.yy.cloud.common.data.otd.sysbase.AdminRegion;
import com.yy.cloud.common.data.otd.sysbase.Region;
...
public class SysBaseServiceImpl implements SysBaseService {
	...
	public List<SysDic> getAllSysdictionary() {
		...
		for (SystemDictionary tempDic : tempCol) {
			...
			tempItem.setDisplayValue(tempDic.getDisplayValue());
