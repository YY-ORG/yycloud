...
public class LdapMgmtController {
	...
	public GeneralContentResult<String> createLdapSource(@RequestBody LdapSourceProfile ldapSource) {
		...
		result = ldapMgmtService.createLdapSource(ldapSource);
		return result;
	}
	...
	public GeneralResult deleteLdapSource(
		...
		GeneralResult result = ldapMgmtService.updateLdapSourceStatus(id, AdUserMgmtConstants.STATUS_GLOBAL_DELETED);
		return result;
	}
